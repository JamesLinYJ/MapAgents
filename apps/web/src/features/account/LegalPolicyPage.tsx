...
const PRIVACY_SECTIONS = [
  ...
  },
  {
    title: '4. 存储与隔离',
    body: [
      '用户、工作区、权限、会话、线程、运行历史、图层和索引元数据保存在 PostgreSQL/PostGIS；上传内容、Artifact 二进制、检查点和记忆正文保存在内容寻址对象存储。',
  ...
  },
  {
    ...
    body: [
      'GeoForge 使用 HTTP-only Cookie 保存 Better Auth 登录会话，并使用 CSRF 令牌保护可变更请求。',
