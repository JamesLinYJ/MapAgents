...
export function bootstrapWorkspace(sessionId?: string): Promise<WorkspaceBootstrapSnapshot> {
  return requestControl('workspace:bootstrap', { sessionId }, workspaceBootstrapSnapshotSchema)
}
