...
} from '../src/store/postgres/conversationRepository.js'
import { decodeCursor, encodeCursor, estimateTokens } from '../src/store/fileConversationIo.js'
...
export class InMemoryConversationRepository implements ConversationRepository {
  ...
  async readThreadHistory(threadId: string, cursor?: string | null, limit = 50): Promise<ThreadHistoryPage> {
    ...
    return {
      ...
      nextCursor: selected.length && selected[0]!.seq > 1 ? encodeCursor(selected[0]!.seq) : null,
    }
  }
