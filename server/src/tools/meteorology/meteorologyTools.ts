...
const METEOROLOGICAL_FILE_SUFFIXES = [...DATASET_SUFFIXES, ...RADAR_SUFFIXES, ...BOUNDARY_SUFFIXES]
...
export const meteorologyTools: ToolDef[] = [
  ...
  tool('prepare_hangzhou_nowcast_scope', '准备杭州短时临近预报范围', '根据问题和已有边界/坐标引用准备杭州区划或地点范围', {
...
function artifactTarget(ctx: ToolContext, artifactType: MeteorologicalArtifactExt, name: string) {
